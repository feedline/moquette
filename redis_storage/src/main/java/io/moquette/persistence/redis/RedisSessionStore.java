...
public class RedisSessionStore implements ISessionsStore, ISubscriptionsStore {
    ...
    public StoredMessage secondPhaseAcknowledged(String clientID, int messageID) {
        ...
        StoredMessage msg = storedOperation.get(m_secondPhaseStore + clientID, String.valueOf(messageID));
        storedOperation.delete(m_secondPhaseStore + clientID, String.valueOf(messageID));
